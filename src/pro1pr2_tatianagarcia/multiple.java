 ...
 * @author tatig
 */
public class multiple  extends Answers{
    ...
    public multiple(double valor, JTextArea pregunta,ButtonGroup botones,JRadioButton bottons[]) {
    ...
    public String toString() {
        return "multiple{" + "botones=" + botones + ", bottons=" + bottons + '}';
    }
